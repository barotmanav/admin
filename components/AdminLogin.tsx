  ...
  return (
    <div className="w-full max-w-md p-8 rounded-2xl glass shadow-2xl border border-white/10 animate-in fade-in zoom-in duration-300">
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-sm mt-2">Login to manage your locations</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className="w-full bg-white/5 hover:bg-white/10 text-gray-300 font-semibold py-3 rounded-xl border border-white/10 transition-all"
        >
          Create Account
        </button>
      </form>
